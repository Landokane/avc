...
//LINK_ENTITY_TO_FUNC(building_camera, "building_camera");

//LINK_ENTITY_TO_CLASS(building_camera, CBuildingCamera);

// entities for Valve's hl.dll and Standard SDK...

//LINK_ENTITY_TO_CLASS( avbeam, CBeam );
